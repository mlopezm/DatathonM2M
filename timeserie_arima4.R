...
################################################################################################
# ## Usando Cross Validation como time series
# #
porctg=0.15  #porcentaje del final usado para test
set.seed(123)
historyruns=NULL
...
historyrunsm
historyrunssd
save (historyruns,file="hr_timeserie_arima4_all_2h_ts.cv_ts.Rdat")
...
save(sample_good,sample_bad,file="./sample_gb/samp_badgood_timeseries_arima32.Rdat")
...
# save(pred.ts.reto,file="timeseries_arima3.pred.ts.0.7tail.Rdat")
# 
# 
# historyrunsm= mean(historyruns[,2])
# historyrunssd= sd(historyruns[,2])
# historyrunsm
# historyrunssd
# save (historyruns,file="hr_timeserie_arima3_all_2h_4hd_ts.0.7tail.Rdat")
# 
# 
# hr=as.data.frame(historyruns)
# ggplot(hr, aes(x=loss)) + geom_density()
...
# pred.ts.reto=cbind(true.pred.ts.reto,fore.pred.ts.reto)
# save(pred.ts.reto,file="timeseries_arima3.pred.ts.reto.Rdat")
# 
# 
# historyrunsm= mean(historyruns[,2])
# historyrunssd= sd(historyruns[,2])
# historyrunsm
# historyrunssd
# save (historyruns,file="hr_timeserie_arima3_all_2h_4hd_ts.reto.Rdat")
# 
# 
# hr=as.data.frame(historyruns)
# ggplot(hr, aes(x=loss)) + geom_density()
...
# sample_good=hr$simid[hr$loss==1]
# sample_bad=hr$simid[hr$loss==-1]
# save(sample_good,sample_bad,file="./sample_gb/samp_badgood_timeseries_arima33.Rdat")
# 
# 
# 
# 
...
# save(pred.final,file="FINAL.arima3.pred.Rdat")
