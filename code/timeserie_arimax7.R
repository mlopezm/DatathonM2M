...
wdh2d_xreg=((1+sim.uwg$h2d)+12*(sim.uwg$wd-1))*rnorm(length(sim.uwg$h2d),1,1e-5)
...
pred.ts.reto=cbind(true.pred.ts.reto,fore.pred.ts.reto)
save(pred.ts.reto,file="timeseries_arimax7.pred.ts.reto.Rdat")
...
historyrunsm
historyrunssd
save (historyruns,file="hr_timeserie_arimax7_all_2h_4hd_ts.reto.Rdat")
...
sample_good=hr$simid[hr$loss==1]
sample_bad=hr$simid[hr$loss==-1]
save(sample_good,sample_bad,file="./sample_gb/samp_badgood_timeseries_arimax73.Rdat")
