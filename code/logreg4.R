...
save(sample_good,sample_bad,file="./sample_gb/samp_badgood_logreg42.Rdat")
...
save(pred.ts.reto,file="logreg4.pred.ts.reto.Rdat")
...
historyrunsm
historyrunssd
save (historyruns,file="hr_logreg4_all_2h_4hd_ts.reto.Rdat")
...
sample_good=hr$simid[hr$loss==1]
sample_bad=hr$simid[hr$loss==-1]
save(sample_good,sample_bad,file="./sample_gb/samp_badgood_logreg43.Rdat")
...
save(pred.final,file="FINAL.logreg4.pred.Rdat")
