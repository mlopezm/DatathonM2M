...
# save(pred.ts.reto,file="timeseries_arimax1.pred.ts.0.7tail.Rdat")
# 
# 
...
# historyrunsm
# historyrunssd
# save (historyruns,file="hr_timeserie_arimax1_all_2h_4hd_ts.0.7tail.Rdat")
# 
# 
...
# save(sample_good,sample_bad,file="./sample_gb/samp_badgood_timeseries_arimax12.Rdat")
...
pred.ts.reto=cbind(true.pred.ts.reto,fore.pred.ts.reto)
save(pred.ts.reto,file="timeseries_arimax4.pred.ts.reto.Rdat")
...
historyrunsm
historyrunssd
save (historyruns,file="hr_timeserie_arimax4_all_2h_4hd_ts.reto.Rdat")
...
sample_good=hr$simid[hr$loss==1]
sample_bad=hr$simid[hr$loss==-1]
save(sample_good,sample_bad,file="./sample_gb/samp_badgood_timeseries_arimax43.Rdat")
